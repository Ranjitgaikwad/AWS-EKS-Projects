...
- Added annotation with two DNS Names
  - dnstest901.gaikwadcloud.com
  - dnstest902.gaikwadcloud.com
...
```yaml
    ...
    external-dns.alpha.kubernetes.io/hostname: dnstest901.gaikwadcloud.com, dnstest902.gaikwadcloud.com
```
...
- You should see **Record Sets** added for `dnstest901.gaikwadcloud.com`, `dnstest902.gaikwadcloud.com`
...
```t
# nslookup commands
nslookup dnstest901.gaikwadcloud.com
nslookup dnstest902.gaikwadcloud.com
```
### Access Application using dnstest1 domain
```t
# HTTP URLs (Should Redirect to HTTPS)
http://dnstest901.gaikwadcloud.com/app1/index.html
http://dnstest901.gaikwadcloud.com/app2/index.html
http://dnstest901.gaikwadcloud.com/
```

### Access Application using dnstest2 domain
```t
# HTTP URLs (Should Redirect to HTTPS)
http://dnstest902.gaikwadcloud.com/app1/index.html
http://dnstest902.gaikwadcloud.com/app2/index.html
http://dnstest902.gaikwadcloud.com/
```
